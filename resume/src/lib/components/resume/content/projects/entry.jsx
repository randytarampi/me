...
export const ResumeProjectsEntry = ({projectsEntry, index}) => {
    const startDate = castDatePropertyToDateTime(projectsEntry.startDate);
    const endDate = projectsEntry.endDate && castDatePropertyToDateTime(projectsEntry.endDate) || null;
                ...
                <Col s={12} className="resume-projects-entry__basics">
                    ...
                    <h4>
                        <span className="resume-projects-entry__name">
                            ...
                            {
                                projectsEntry.url
                                    ? <CampaignLink href={projectsEntry.url} text={projectsEntry.name}/>
                                    : projectsEntry.name
                            }
                            </span>
                        </span>
