...
class Pseudoimager {
	 ...
	 * @param {string} sourceDirectory - The directory to create pseudoimages for
	 * @param {string} destinationDirectory - The destination to place the pseudoimages in
	 * @param {number} relativeScale - Scales the pseudoimage size relative to the source image, defaults to 2
	 */
	static retina(sourceDirectory, destinationDirectory, relativeScale) {
		return new Pseudoimager(sourceDirectory, destinationDirectory, relativeScale || 2);
	}
