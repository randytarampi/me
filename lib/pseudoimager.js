...
class Pseudoimager {
	...
	static retina(sourceDirectory, destinationDirectory) {
		return new Pseudoimager(sourceDirectory, destinationDirectory, retinizedImageTransformation);
	}
	...
	static half(sourceDirectory, destinationDirectory) {
		return new Pseudoimager(sourceDirectory, destinationDirectory, halfImageTransformation);
	}
