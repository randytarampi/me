...
import {buildFetchUrlForVariant} from "../../../../lib/api/fetchResume";
...
describe("fetchResume", function () {
    ...
    describe("FETCHING_RESUME", function () {
        it("isn't dispatched if already `isLoading`", function () {
            ...
            const proxyquiredFetchResume = proxyquire("../../../../lib/actions/fetchResume", {
                "../api/fetchResume": {
        ...
        it("isn't dispatched if already loaded the resume variant", function () {
            const stubVariant = "test";
            const stubResumeResponse = testResumeJson;
