    ...
    return <ResumeSection
        ...
        descriptionNode={
            <Fragment>
                ...
                <p><span className="text">Ask me about how I ended up learning Italian on the job, my cadrés of co-op students, or whenI almost <Link href="http://www.quickmeme.com/p/3vv8p3">brought down a busy test environment</Link> as an intern</span></p>
            </Fragment>
        }
    >
        {
