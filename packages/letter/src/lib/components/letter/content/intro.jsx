                    ...
                    <p className="letter-intro__content">
                        {
                            contentConfiguration.contentProps.intro || <Fragment>
                                I hope this letter finds you well. I'm an honest guy so I'll just tell you right now that <CampaignLink href="https://github.com/randytarampi/me/tree/master/packages/letter#readme">this letter was autogenerated</CampaignLink>. No disrespect intended of course — your time is valuable and so is mine, and I figured that since this is an application for a software development role I'd develop some software to build this letter (and my <CampaignLink href="https://github.com/randytarampi/me/tree/master/packages/resume#readme" text="resume"/> too).
                            </Fragment>
                        }
                    </p>
                    <p className="letter-intro__content">
