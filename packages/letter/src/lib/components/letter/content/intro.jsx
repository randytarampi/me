            ...
            contentConfiguration.contentProps.children
                ...
                : <Fragment>
                    <p className="letter-intro__content">
                        {
                            contentConfiguration.contentProps.intro || <Fragment>
                                I hope this letter finds you well. I'm a forthright and honest guy, so I'll just tell you
                                right now
                                that <CampaignLink
                                ...
                                valuable and so is mine, and I figured that since this is an application for a software
                                development
                                role I'd develop some software to build this letter (and my <CampaignLink
                                href="https://github.com/randytarampi/me/tree/master/packages/resume#readme"
                                text="resume"/> too).
                            </Fragment>
                        }
                    </p>
                    <p className="letter-intro__content">
                        ...
                        of you please <EmailLink useBranding={false} subject="I read your cover letter!">let me
                        know</EmailLink>, if
