...
- Generate both a cover letter and resume for a specific configuration at the same time, useful for consistently capturing time-sensitive information, like [shield](https://github.com/randytarampi/me/tree/main/packages/jsx/src/lib/components/link/shields) statuses.
...
1. Place a JS/JSX file (say [`some-awesome-company.jsx`](https://github.com/randytarampi/me/blob/main/packages/job-application/src/job-applications/some-awesome-company.jsx)) that returns an instance of [`JobApplication`](./src/lib/jobApplication) in `/src/job-applications`
