...
import Emoji from "../../../../../src/lib/components/emoji";
...
describe("Emoji", function () {
    ...
    it("renders (textEffect)", function () {
        const stubProps = {
            id: "woof",
            htmlId: "meow",
            location: Map({
        ...
        const stubChildren = <span id="woof-child">Woof</span>;
        const rendered = mount(<Emoji {...stubProps}>{stubChildren}</Emoji>);
    ...
    it("renders (no `clearEmoji`)", function () {
        const stubProps = {
            id: "woof",
            htmlId: "meow",
            location: Map({
    ...
    it("renders (no `instantiateEmoji`)", function () {
        const stubProps = {
            id: "woof",
            htmlId: "meow",
            location: Map({
