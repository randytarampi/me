...
describe("ClientReduxRoot", function () {
    ...
    describe("constructor", function () {
        it("logs a greeting (generic)", function () {
            const rendered = mount(stubStore)(<ClientReduxRoot store={stubStore} history={stubHistory} routes={stubRoutes}/>);
    ...
    it("renders", function () {
        ...
        const rendered = mount(stubStore)(<ClientReduxRoot {...stubProps} store={stubStore} history={stubHistory} routes={stubRoutes}/>);
