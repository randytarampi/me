...
class Bear extends Emoji {
    ...
    render() {
        return <div className={["bear", this.toString()].join(" ")}>
            <span className="bear__leftAction"
                  onClick={this.onClick.bind(this, "leftAction")}>{this.state.leftAction}</span>
            <span className="bear__leftLeaningLeftArm"
                  onClick={this.onClick.bind(this, "leftLeaningLeftArm")}>{this.state.leftLeaningLeftArm}</span>
            <span className="bear__leftEar" onClick={this.onClick.bind(this, "leftEar")}>{this.state.leftEar}</span>
            <span className="bear__rightLeaningLeftArm"
                  onClick={this.onClick.bind(this, "rightLeaningLeftArm")}>{this.state.rightLeaningLeftArm}</span>
            ...
            <span className="bear__leftLeaningRightArm"
                  onClick={this.onClick.bind(this, "leftLeaningRightArm")}>{this.state.leftLeaningRightArm}</span>
            <span className="bear__rightEar" onClick={this.onClick.bind(this, "rightEar")}>{this.state.rightEar}</span>
            <span className="bear__rightLeaningRightArm"
