...
importScripts(
  "/precache-manifest.c586028d429e39cd4ef3f8884fbc949a.js"
);
...
workbox.routing.registerRoute(/\.(?:png|jpg|jpeg|eot|ttf|woff|woff2|svg|gif|ico)$/, workbox.strategies.staleWhileRevalidate({ "cacheName":"assets", plugins: [] }), 'GET');
